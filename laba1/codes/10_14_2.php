...
<body>
    <form action="{$_SERVER['PHP_SELF']}" method="POST"> 
		...
		Введите фамилию  &nbsp; <input type="text" name="email" placeholder="Укажите e-mail"><br><br>
        Предпочитаете &nbsp; 
...
if(isset($_POST["submit"])){
 ...
 $email = $_POST['email'];
 $email = htmlspecialchars($email); //преобразование символов
 $email = urldecode($email); //декодирование юрл
 $email = trim($email); // удаление лишних пробелов
...
mail("example@mail.ru", "Заявка с сайта", "ФИО:",". E-mail: ".$email ,"From: example2@mail.ru \r\n");
